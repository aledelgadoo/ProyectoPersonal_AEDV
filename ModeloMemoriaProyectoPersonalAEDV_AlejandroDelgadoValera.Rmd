...
<!---TRAS HABER EJECUTADO EL ARCHIVO guardar_datasets_local.R LEEMOS DESDE LOCAL --->
```{r, echo=F}
...
* **code**: `r dataset.original$code[1]`
* **title**: `r dataset.original$title[1]`
* **last.update.of.data**: `r dataset.original$last.update.of.data[1]`
<!-- * **last.table.structure.change**: `r dataset.original$last.table.structure.change[1]` --> 
* **data.start**: `r dataset.original$data.start[1]`
* **data.end**: `r dataset.original$data.end[1]`
* **values**: `r format(dataset.original$values[1],big.mark = ".")`
